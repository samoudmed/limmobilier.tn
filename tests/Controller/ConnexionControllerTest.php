...
class ConnexionControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Connexion::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'connexion[createdAt]' => 'Testing',
            'connexion[user]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'connexion[createdAt]' => 'Something New',
            'connexion[user]' => 'Something New',
        ]);
