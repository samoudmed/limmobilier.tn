...
class ResizePhoto {
    ...
    public function __construct($fileName) {
        ...
        $this->image = imagecreatefromstring($fileContents);

        if ($this->image === false) {
            throw new \Exception("Unable to create image from string for: $fileName");
        }
    ...
    public function saveImage($savePath, $imageQuality = "100") {
        ...
        switch ($extension) {
            case '.jpg':
            case '.jpeg':
            case '.jfif':  // Add this case for .jfif
